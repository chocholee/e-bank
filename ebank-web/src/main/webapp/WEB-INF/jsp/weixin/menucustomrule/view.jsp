...
<tmpl:override name="title">查看个性化菜单规则</tmpl:override>
    ...
    <div class="block">
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" lay-verify="required" autocomplete="off" class="layui-input"
                           value="${menuCustomRule.name}" disabled>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input class="layui-input" lay-verify="required" type="text" name="menuCustomName"
                           value="${menuCustomRule.menuCustom.name}" disabled>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input class="layui-input" lay-verify="required" type="text" name="groupWechatName"
                           value="${menuCustomRule.groupWechat.name}" disabled>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="remark" placeholder="请输入备注" class="layui-textarea" disabled>${menuCustomRule.remark}</textarea>
                </div>
            </div>
        </form>
    </div>
