...
<tmpl:override name="title">编辑微信场景</tmpl:override>
...
<tmpl:override name="body">
    <div class="block">
        <form class="layui-form" action="${pageContext.request.contextPath}/weixin/scene/edit/${scene.id}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="remark" placeholder="请输入备注" class="layui-textarea">${scene.remark}</textarea>
                </div>
            </div>
        </form>
    </div>
