...
<tmpl:override name="body">
    ...
    <div class="button-wrapper">
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/scene/list/select">
        ...
        <table class="table" cellspacing="0">
            ...
            <c:if test="${pagination ne null && pagination.data ne null}">
                <c:forEach var="scene" items="${pagination.data}">
                    <tr>
                        <td><input type="checkbox" name="id" value="${scene.id}"></td>
                        <td>${scene.name}</td>
                        <td>${scene.remark}</td>
    ...
    <jsp:include page="../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/scene/list/select?name=${scene.name}"/>
    </jsp:include>
</tmpl:override>
