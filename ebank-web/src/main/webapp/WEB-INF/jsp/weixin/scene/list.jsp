...
<tmpl:override name="title">场景列表</tmpl:override>
...
<tmpl:override name="rightBox">
    ...
    <div class="button-wrapper">
        <div class="left button-group-wrapper">
            <sec:authorize url="/weixin/scene/add">
                <div class="button-group mr-20">
                    <a href="javascript:CURD.add('${pageContext.request.contextPath}/weixin/scene/add', '新增', '600px', '345px');" class="button">
        ...
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/scene/list">
                <div class="form-group">
                    <label>名称</label>
                    <input name="name" type="text" class="form-control" value="${scene.name}">
                </div>
                <div class="form-group">
    ...
    <div id="table">
        <table class="table" cellspacing="0">
            ...
            <c:if test="${pagination ne null && pagination.data ne null}">
                <c:forEach var="scene" items="${pagination.data}">
                    <tr>
                        <td>${scene.name}</td>
                        <td>${scene.remark}</td>
                        <td>${scene.createdDate}</td>
                        <td class="last-td">
                            <sec:authorize url="/weixin/scene/view/">
                                <a href="javascript:CURD.view('${pageContext.request.contextPath}/weixin/scene/view/${scene.id}', '查看', '650px', '355px')" title="查看">
                                    <img src="${pageContext.request.contextPath}/resources/images/eye.png">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/scene/edit/">
                                <a href="javascript:CURD.edit('${pageContext.request.contextPath}/weixin/scene/edit/${scene.id}', '编辑', '600px', '345px')" title="编辑">
                                    <img src="${pageContext.request.contextPath}/resources/images/edit.png" alt="编辑">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/scene/delete/">
                                <a href="javascript:CURD.delete('${pageContext.request.contextPath}/weixin/scene/delete/${scene.id}')" title="删除">
    ...
    <jsp:include page="../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/scene/list?name=${scene.name}"/>
    </jsp:include>
</tmpl:override>
