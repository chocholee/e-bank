...
<tmpl:override name="body">
    ...
    <div class="button-wrapper">
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/channel/list/select">
    ...
    <jsp:include page="../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/channel/list/select?name=${channel.name}"/>
    </jsp:include>
</tmpl:override>
