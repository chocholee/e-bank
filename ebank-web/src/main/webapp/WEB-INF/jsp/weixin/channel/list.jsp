...
<tmpl:override name="title">渠道列表</tmpl:override>
...
<tmpl:override name="rightBox">
    ...
    <div class="button-wrapper">
        <div class="left button-group-wrapper">
            <sec:authorize url="/weixin/channel/add">
                <div class="button-group mr-20">
                    <a href="javascript:CURD.add('${pageContext.request.contextPath}/weixin/channel/add', '新增', '600px', '345px');" class="button">
        ...
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/channel/list">
    ...
    <div id="table">
        <table class="table" cellspacing="0">
            ...
            <c:if test="${pagination ne null && pagination.data ne null}">
                <c:forEach var="channel" items="${pagination.data}">
                    <tr>
                        <td>${channel.name}</td>
                        <td>${channel.remark}</td>
                        <td>${channel.createdDate}</td>
                        <td class="last-td">
                            <sec:authorize url="/weixin/channel/view/">
                                <a href="javascript:CURD.view('${pageContext.request.contextPath}/weixin/channel/view/${channel.id}', '查看', '650px', '355px')" title="查看">
                                    <img src="${pageContext.request.contextPath}/resources/images/eye.png">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/channel/edit/">
                                <a href="javascript:CURD.edit('${pageContext.request.contextPath}/weixin/channel/edit/${channel.id}', '编辑', '600px', '345px')" title="编辑">
                                    <img src="${pageContext.request.contextPath}/resources/images/edit.png" alt="编辑">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/channel/delete/">
                                <a href="javascript:CURD.delete('${pageContext.request.contextPath}/weixin/channel/delete/${channel.id}')" title="删除">
    ...
    <jsp:include page="../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/channel/list?name=${channel.name}"/>
    </jsp:include>
</tmpl:override>
