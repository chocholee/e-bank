...
<tmpl:override name="title">新增分组</tmpl:override>
...
<tmpl:override name="body">
    <div class="block">
        <form class="layui-form" action="${pageContext.request.contextPath}/weixin/group/add" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="type" title="微信分组" value="WECHAT" lay-verify="required" checked>
                    <input type="radio" name="type" title="虚拟分组" value="VIRTUAL" lay-verify="required">
                </div>
            </div>
