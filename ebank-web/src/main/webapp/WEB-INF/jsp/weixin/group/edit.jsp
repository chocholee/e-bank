...
<tmpl:override name="title">编辑分组</tmpl:override>
...
<tmpl:override name="body">
    <div class="block">
        <form class="layui-form" action="${pageContext.request.contextPath}/weixin/group/edit/${group.id}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="type" title="微信分组" value="WECHAT" lay-verify="required" readonly
                           <c:if test="${group.type eq 'WECHAT'}">checked</c:if>>
                    <input type="radio" name="type" title="虚拟分组" value="VIRTUAL" lay-verify="required" readonly
                           <c:if test="${group.type eq 'VIRTUAL'}">checked</c:if>>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="remark" placeholder="请输入备注" class="layui-textarea">${group.remark}</textarea>
                </div>
            </div>
        </form>
    </div>
