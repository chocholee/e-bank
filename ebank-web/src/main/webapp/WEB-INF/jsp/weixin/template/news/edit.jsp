...
<tmpl:override name="title">编辑图文消息</tmpl:override>
...
<tmpl:override name="body">
    <div class="block">
        <form class="layui-form" action="${pageContext.request.contextPath}/weixin/template/news/edit/${news.id}" method="post">
