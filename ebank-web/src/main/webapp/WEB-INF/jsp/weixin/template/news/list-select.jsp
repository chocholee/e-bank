...
<tmpl:override name="title">选择图文信息</tmpl:override>
...
<tmpl:override name="body">
    ...
    <div class="button-wrapper">
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/template/news/list/select">
    ...
    <jsp:include page="../../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/template/news/list/select?name=${news.name}"/>
    </jsp:include>
</tmpl:override>
