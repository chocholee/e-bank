...
<tmpl:override name="title">新增文本消息</tmpl:override>
...
<tmpl:override name="body">
    <div class="block">
        <form class="layui-form" action="${pageContext.request.contextPath}/weixin/template/text/add" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="content" lay-verify="required" placeholder="请输入内容" class="layui-textarea">${text.content}</textarea>
                </div>
            </div>
        </form>
    </div>
