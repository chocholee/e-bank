...
<tmpl:override name="title">选择图片信息</tmpl:override>
...
<tmpl:override name="body">
    ...
    <div class="button-wrapper">
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/template/image/list/select">
        ...
        <table class="table" cellspacing="0">
            ...
            <c:if test="${pagination ne null && pagination.data ne null}">
                <c:forEach var="image" items="${pagination.data}">
                    <tr>
                        <td><input type="checkbox" name="id" value="${image.id}"></td>
                        <td>${image.name}</td>
    ...
    <jsp:include page="../../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/template/image/list/select?name=${image.name}"/>
    </jsp:include>
</tmpl:override>
