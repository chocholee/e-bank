...
<tmpl:override name="title">选择文本信息</tmpl:override>
...
<tmpl:override name="body">
    ...
    <div class="button-wrapper">
        <div class="right">
            <form class="form-inline" role="form" action="${pageContext.request.contextPath}/weixin/template/text/list/select">
        ...
        <table class="table" cellspacing="0">
            ...
            <c:if test="${pagination ne null && pagination.data ne null}">
                <c:forEach var="text" items="${pagination.data}">
                    <tr>
                        <td><input type="checkbox" name="id" value="${text.id}"></td>
                        <td>${text.name}</td>
                        <td>${text.content}</td>
    ...
    <jsp:include page="../../../shared/pagination.jsp" flush="true">
        ...
        <jsp:param name="paginationURL" value="${pageContext.request.contextPath}/weixin/template/text/list/select?name=${text.name}"/>
    </jsp:include>
</tmpl:override>
