        ...
        <div class="left button-group-wrapper">
            <sec:authorize url="/weixin/template/news/add">
                <div class="button-group mr-20">
                    <a href="javascript:_add('${pageContext.request.contextPath}/weixin/template/news/add', '新增', '600px', '230px');" class="button">
                    ...
                    <tr>
                        ...
                        <td class="last-td">
                            <sec:authorize url="/weixin/template/news/item/view/">
                                <a href="javascript:_view('${pageContext.request.contextPath}/weixin/template/news/item/view/${news.id}', '查看图文项', '360px', '600px')" title="查看图文项">
                                    <img src="${pageContext.request.contextPath}/resources/images/eye.png">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/template/news/item/add/">
                                <a href="javascript:_add('${pageContext.request.contextPath}/weixin/template/news/item/add/${news.id}', '添加图文项', '900px', '495px')" title="添加图文项">
                                    <img src="${pageContext.request.contextPath}/resources/images/add.png">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/template/news/edit/">
                                <a href="javascript:_edit('${pageContext.request.contextPath}/weixin/template/news/edit/${news.id}', '编辑', '600px', '230px')" title="编辑">
                                    <img src="${pageContext.request.contextPath}/resources/images/edit.png" alt="编辑">
                                </a>
                            </sec:authorize>
                            <sec:authorize url="/weixin/template/news/delete/">
                                <a href="javascript:_delete('${pageContext.request.contextPath}/weixin/template/news/delete/${news.id}')" title="删除">
