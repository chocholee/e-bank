...
<tmpl:override name="title">查看文本消息</tmpl:override>
    ...
    <div class="block">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="content" lay-verify="required" placeholder="请输入内容" class="layui-textarea"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" lay-verify="required" autocomplete="off" class="layui-input"
                           value="${text.createdDate}" disabled>
                </div>
            </div>
        </form>
    </div>
